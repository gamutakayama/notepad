...
class V {
  ...
  */
  applyTransaction(e) {
    ...
    let s;
    t ? s = e.startState.values.slice() : (t = Wr.resolve(i, n, this), s = new V(t, this.doc, this.selection, t.dynamicSlots.map(() => null), (a, h) => h.reconfigure(a, this), null).values);
  ...
  */
  toText(e) {
    return Y.of(e.split(this.facet(V.lineSeparator) || rs));
  }
  /**
  ...
  */
  static create(e = {}) {
    let t = Wr.resolve(e.extensions || [], /* @__PURE__ */ new Map()), i = e.doc instanceof Y ? e.doc : Y.of((e.doc || "").split(t.staticFacet(V.lineSeparator) || rs)), n = e.selection ? e.selection instanceof S ? e.selection : S.single(e.selection.anchor, e.selection.head) : S.single(0);
...
const Mp = /* @__PURE__ */ Qe.fromClass(class {
  ...
  syncGutters(r) {
    ...
    let t = _.iter(this.view.state.facet(Yr), this.view.viewport.from), i = [], n = this.gutters.map((s) => new zp(s, this.view.viewport, -this.view.documentPadding.top));
  ...
  updateGutters(r) {
    let e = r.startState.facet(Ai), t = r.state.facet(Ai), i = r.docChanged || r.heightChanged || r.viewportChanged || !_.eq(r.startState.facet(Yr), r.state.facet(Yr), r.view.viewport.from, r.view.viewport.to);
    if (e == t)
...
function BS() {
  if (ts)
    return ts;
  let r = wS(new Gg(V.create({ extensions: Uu }), 0, !0));
...
}, FS = ({ state: r, dispatch: e }) => r.selection.ranges.some((t) => !t.empty) ? Yf({ state: r, dispatch: e }) : (e(
  r.update(r.replaceSelection(r.facet(hi)), {
    scrollIntoView: !0,
    userEvent: "input"
  })
), !0), HS = { key: "Tab", run: FS, shift: _f };
export {
