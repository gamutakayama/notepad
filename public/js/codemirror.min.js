...
for (var le = 65; le <= 90; le++)
  yt[le] = String.fromCharCode(le + 32), Li[le] = String.fromCharCode(le);
for (var xn in yt) Li.hasOwnProperty(xn) || (Li[xn] = yt[xn]);
function SO(r) {
  var e = mO && r.metaKey && r.shiftKey && !r.ctrlKey && !r.altKey || QO && r.shiftKey && r.key && r.key.length == 1 || r.key == "Unidentified", t = !e && r.key || (r.shiftKey ? Li : yt)[r.keyCode] || r.key || "Unidentified";
...
class cl extends I {
  ...
  enforceCursorAssoc() {
    if (this.hasComposition)
      return;
    let { view: e } = this, t = e.state.selection.main, i = Ei(e.root), { anchorNode: n, anchorOffset: s } = e.observer.selectionRange;
...
const Nd = /* @__PURE__ */ oi.default(/* @__PURE__ */ A.domEventHandlers({
  keydown(r, e) {
...
function Kd(r, e, t, i) {
  ...
  !(v.mac && e.altKey && !(e.ctrlKey || e.metaKey)) && (d = yt[e.keyCode]) && d != n ? (u(O[l + xr(d, e, !0)]) || e.shiftKey && (p = Li[e.keyCode]) != n && p != d && u(O[l + xr(p, e, !1)])) && (a = !0) : o && e.shiftKey && u(O[l + xr(n, e, !0)]) && (a = !0), !a && u(O._any) && (a = !0)), h && (a = !0), a && c && e.stopPropagation(), zs = null, a;
}
class sr {
  /**
...
function Jd(r, e, t) {
  ...
  function k(y, P, $) {
    ...
    function M(q, F, Oe, ke, We) {
      ...
      !se || !Ce || (D = Math.min(se.top, Ce.top, D), L = Math.max(se.bottom, Ce.bottom, L), We == J.LTR ? G.push(s && F ? f : se.left, s && ke ? u : Ce.right) : G.push(!s && ke ? f : Ce.left, !s && F ? u : se.right));
    }
    let X = y ?? $.from, W = P ?? $.to;
    ...
    return G.length == 0 && M(X, y == null, W, P == null, r.textDirection), { top: D, bottom: L, horizontal: G };
  }
  function T(y, P) {
...
class tp {
  ...
  update(e) {
    e.startState.facet(Lr) != e.state.facet(Lr) && this.setOrder(e.state), (this.layer.update(e, this.dom) || e.geometryChanged) && (this.scale(), e.view.requestMeasure(this.measureReq));
  }
  docViewUpdate(e) {
    this.layer.updateOnDocViewUpdate !== !1 && e.requestMeasure(this.measureReq);
  }
  setOrder(e) {
    let t = 0, i = e.facet(Lr);
...
}), sp = /* @__PURE__ */ oi.highest(/* @__PURE__ */ A.theme({
  ".cm-line": {
...
function dp() {
  return _l || (_l = Qe.fromClass(class {
    constructor(r) {
      this.view = r, this.decorations = z.none, this.decorationCache = /* @__PURE__ */ Object.create(null), this.decorator = this.makeDecorator(r.state.facet(Er)), this.decorations = this.decorator.createDeco(r);
    }
    makeDecorator(r) {
      return new hp({
    ...
    update(r) {
      ...
      r.startState.facet(Er) != e ? (this.decorator = this.makeDecorator(e), this.decorations = this.decorator.createDeco(r.view)) : this.decorations = this.decorator.updateDeco(r, this.decorations);
    }
  }, {
...
function xp(r) {
  ...
  return typeof r == "string" ? [
    e,
    A.contentAttributes.of({ "aria-placeholder": r })
  ] : e;
}
const Es = 2e3;
function wp(r, e, t) {
...
function Vl(r, e) {
  let t = r.posAtCoords({ x: e.clientX, y: e.clientY }, !1), i = r.state.doc.lineAt(t), n = t - i.from, s = n > Es ? -1 : n == i.length ? Pp(r, e.clientX) : _e(i.text, r.state.tabSize, t - i.from);
...
function vp(r) {
  ...
  return A.mouseSelectionStyle.of((t, i) => e(i) ? $p(t, i) : null);
}
const Tp = {
  Alt: [18, (r) => !!r.altKey],
...
class Xc {
  ...
  update(e, t, i, n) {
    this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != i && (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""), Lp(this.markers, n) || this.setMarkers(e, n);
  }
  setMarkers(e, t) {
...
const Ep = /* @__PURE__ */ C.define(), Yp = /* @__PURE__ */ C.define(), Wt = /* @__PURE__ */ C.define({
  combine(r) {
...
function Up(r) {
  ...
  function u(y, P, $, D) {
    ...
    for (; l.pos > P; ) {
      ...
      if (F > 4)
        ...
        if (M > -1 && W < M)
          break;
        M < 0 && (M = q - n), L.push(X, W, q), G++, l.next();
      }
    }
    if (G) {
      let X = new Uint16Array(G * 4), W = L[L.length - 2];
      for (let q = L.length - 3, F = 0; q >= 0; q -= 3)
        X[F++] = L[q], X[F++] = L[q + 1] - W, X[F++] = L[q + 2] - W, X[F++] = F;
      $.push(new wt(X, L[2] - W, i)), D.push(W - y);
    }
  }
  function O(y, P) {
    return ($, D, L) => {
  ...
  function d(y, P, $, D, L, G, M, X, W) {
    let q = [], F = [];
    for (; y.length > D; )
      q.push(y.pop()), F.push(P.pop() + $ - L);
    y.push(p(i.types[M], q, F, G - L, X - G, W)), P.push(L - $);
  }
  function p(y, P, $, D, L, G, M) {
    if (G) {
  ...
  function m(y, P) {
    let $ = l.fork(), D = 0, L = 0, G = 0, M = $.end - n, X = { size: 0, start: 0, skip: 0 };
    e: for (let W = $.pos - y; $.pos > W; ) {
      let q = $.size;
      if ($.id == P && q >= 0) {
        X.size = D, X.start = L, X.skip = G, G += 4, D += 4, $.next();
        continue;
      }
      let F = $.pos - q;
      if (q < 0 || F < W || $.start < M)
    ...
    return (P < 0 || D == y) && (X.size = D, X.start = L, X.skip = G), X.size > 4 ? X : void 0;
  }
  function Q(y, P, $) {
    let { id: D, start: L, end: G, size: M } = l;
    if (l.next(), M >= 0 && D < o) {
      let X = $;
      if (M > 4) {
        let W = l.pos - (M - 4);
...
function Zg(r = {}) {
  let e = { ...Cg, ...r }, t = new Ln(e, !0), i = new Ln(e, !1), n = Qe.fromClass(class {
    constructor(o) {
...
function Fc(r, e) {
  let t = [Mg], i;
  return r instanceof ar && (r.module && t.push(A.styleModule.of(r.module)), i = r.themeType), i ? t.push(Bs.computeN([A.darkTheme], (n) => n.facet(A.darkTheme) == (i == "dark") ? [r] : [])) : t.push(Bs.of(r)), t;
}
class Rg {
  constructor(e) {
...
}), Lg = /* @__PURE__ */ z.mark({ class: "cm-matchingBracket" }), Eg = /* @__PURE__ */ z.mark({ class: "cm-nonmatchingBracket" });
function Yg(r) {
  let e = [], t = r.matched ? Lg : Eg;
...
const Kg = /* @__PURE__ */ Ot.define(), Jg = /* @__PURE__ */ A.baseTheme({
...
const hr = /* @__PURE__ */ j.define({
  ...
  provide: (r) => A.decorations.from(r, (e) => e ? e.deco : z.none)
});
function Co(r, e) {
...
const cm = /* @__PURE__ */ A.domEventHandlers({
  mousedown(r, e) {
...
const um = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), Om = /* @__PURE__ */ A.inputHandler.of((r, e, t, i) => {
...
function uf(r, e) {
  if (r.length) {
    let t = r[r.length - 1], i = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - Lm));
  ...
  pop(e, t, i) {
    ...
    if (i && s.selectionsAfter.length)
      return t.update({
        ...
        annotations: js.of({ side: e, rest: Em(n), selection: o }),
...
const e0 = (r) => Pf(r, !ue(r)), t0 = (r) => Pf(r, ue(r)), i0 = (r) => Ee(r, (e) => Qn(r.state, e, !ue(r))), r0 = (r) => Ee(r, (e) => Qn(r.state, e, ue(r)));
function $f(r, e) {
...
const pa = (r) => Cf(r, !1), ga = (r) => Cf(r, !0), n0 = (r) => Ee(r, (e) => $t(r, e, !0)), s0 = (r) => Ee(r, (e) => $t(r, e, !1)), o0 = (r) => Ee(r, (e) => $t(r, e, !ue(r))), l0 = (r) => Ee(r, (e) => $t(r, e, ue(r))), a0 = (r) => Ee(r, (e) => S.cursor(r.lineBlockAt(e.head).from)), h0 = (r) => Ee(r, (e) => S.cursor(r.lineBlockAt(e.head).to)), ma = ({ state: r, dispatch: e }) => (e(qe(r, { anchor: 0 })), !0), Qa = ({ state: r, dispatch: e }) => (e(qe(r, { anchor: r.doc.length })), !0), Sa = ({ state: r, dispatch: e }) => (e(qe(r, { anchor: r.selection.main.anchor, head: 0 })), !0), ba = ({ state: r, dispatch: e }) => (e(qe(r, { anchor: r.selection.main.anchor, head: r.doc.length })), !0), c0 = ({ state: r, dispatch: e }) => (e(r.update({ selection: { anchor: 0, head: r.doc.length }, userEvent: "select" })), !0), f0 = ({ state: r, dispatch: e }) => {
...
const w0 = ({ state: r, dispatch: e }) => Lf(r, e, !1), P0 = ({ state: r, dispatch: e }) => Lf(r, e, !0), $0 = (r) => {
  if (r.state.readOnly)
    return !1;
...
const ka = /* @__PURE__ */ Ef(!1), T0 = /* @__PURE__ */ Ef(!0);
function Ef(r) {
  return ({ state: e, dispatch: t }) => {
    if (e.readOnly)
      return !1;
...
const Vf = {
  [x.Blockquote](r, e, t) {
    return t.next != 62 ? !1 : (t.markers.push(E(x.QuoteMark, e.lineStart + t.pos, e.lineStart + t.pos + 1)), t.moveBase(t.pos + (Ye(t.text.charCodeAt(t.pos + 1)) ? 2 : 1)), r.end = e.lineStart + t.text.length, !0);
  },
  [x.ListItem](r, e, t) {
...
const Cr = {
  ...
  FencedCode(r, e) {
    ...
    if (t < 0)
      return !1;
    let i = r.lineStart + e.pos, n = e.next, s = t - e.pos, o = e.skipSpace(t), l = xa(e.text, e.text.length, o), a = [E(x.CodeMark, i, i + s)];
    ...
    for (let h = !0; r.nextLine() && e.depth >= r.stack.length; h = !1) {
      ...
      if (c - e.pos >= s && e.skipSpace(c) == e.text.length) {
        for (let f of e.markers)
          a.push(f);
        a.push(E(x.CodeMark, r.lineStart + e.pos, r.lineStart + c)), r.nextLine();
        break;
      } else {
...
`);
  ...
  */
  ...
  elt(e, t, i, n) {
    return typeof e == "string" ? E(this.parser.getNodeType(e), t, i, n) : new Jf(e, t);
  }
  /**
  @internal
  */
...
function D0(r, e, t, i, n) {
  ...
  if (e.unshift(E(x.LinkMark, i, i + (t == x.Image ? 2 : 1))), e.push(E(x.LinkMark, n - 1, n)), o == 40) {
    ...
    h && (a = r.skipSpace(h.to), a != h.to && (c = ru(s, a - r.offset, r.offset), c && (a = r.skipSpace(c.to)))), r.char(a) == 41 && (e.push(E(x.LinkMark, n, n + 1)), l = a + 1, h && e.push(h), c && e.push(c), e.push(E(x.LinkMark, a, l)));
  } else if (o == 91) {
...
const DQ = [Yo, Ou, cu, fu, uu], qQ = new hu({
  ...
  if (t) {
    ...
    if (n && LQ[n]) return r.acceptToken(In, -2);
...
const Ka = /* @__PURE__ */ new Ec(), C1 = ["Declaration"];
function Z1(r) {
  for (let e = r; ; ) {
    if (e.type.isTop)
      return e;
...
const M1 = 316, z1 = 317, Ja = 1, L1 = 2, E1 = 3, Y1 = 4, _1 = 318, V1 = 320, D1 = 321, q1 = 5, B1 = 6, W1 = 0, io = [
  9,
  10,
  11,
  12,
  ...
  if (t == G1 || t == N1) {
    if (r.advance(), t == r.next) {
      ...
      r.acceptToken(i ? Ja : L1);
    }
  } else t == H1 && r.peek(1) == K1 && (r.advance(), r.advance(), (r.next < 48 || r.next > 57) && r.acceptToken(E1));
}, { contextual: !0 });
function Un(r, e) {
...
const QS = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), SS = /* @__PURE__ */ A.inputHandler.of((r, e, t, i, n) => {
...
}), bi = ["_blank", "_self", "_top", "_parent"], Fn = ["ascii", "utf-8", "utf-16", "latin1", "latin1"], Hn = ["get", "post", "put", "delete"], Kn = ["application/x-www-form-urlencoded", "multipart/form-data", "text/plain"], xe = ["true", "false"], Z = {}, bS = {
  a: {
    attrs: {
      href: null,
      ping: null,
...
class Ki {
  constructor(e, t) {
    this.tags = { ...bS, ...e }, this.globalAttrs = { ...Lu, ...t }, this.allTags = Object.keys(this.tags), this.globalAttrNames = Object.keys(this.globalAttrs);
  }
}
...
].concat(/* @__PURE__ */ Eu.map((r) => ({ name: r, parser: rt.parser }))), Bu = /* @__PURE__ */ ei.define({
  name: "html",
...
const sh = /* @__PURE__ */ new Set(/* @__PURE__ */ "area base br col command embed frame hr img input keygen link meta param source track wbr menuitem".split(" ")), TS = /* @__PURE__ */ A.inputHandler.of((r, e, t, i, n) => {
...
const zS = (r = {}) => ({ state: e, dispatch: t }) => {
  let i = U(e), { doc: n } = e, s = null, o = e.changeByRange((l) => {
    ...
    for (; m > h.from && /\s/.test(h.text.charAt(m - h.from - 1)); )
      m--;
    return p = Wo(p, e), ES(f.node, e.doc) && (p = lh(c, e, h) + e.lineBreak + p), O.push({ from: m, to: a, insert: e.lineBreak + p }), { range: S.cursor(m + p.length + 1), changes: O };
  });
...
const WS = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i, IS = /* @__PURE__ */ A.domEventHandlers({
  paste: (r, e) => {
    var t;
  ...
  shift: _f
}, HS = _.changeFilter.of((r) => r.newDoc.length <= 99999);
export {
  nb as initCodeMirror
};
